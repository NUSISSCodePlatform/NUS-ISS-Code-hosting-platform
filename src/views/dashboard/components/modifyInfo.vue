            ...
            <el-main style="height: 100%;">
              <el-form ref="form" :model="form" label-width="120px" label-position="left">
                <el-form-item label="Name">
                  <el-input :placeholder="this.userName"
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      if (password.length < 4 || password.length > 16) {
        this.$message.error('Password must be between 4 and 16 characters');
        return;
      }
      ...
      try {
        ...
        const response = await apiClient.put('/users/edit/profile', {
          username: localStorage.getItem('username'),
          password: password,
